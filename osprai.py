...
class image:
	def __init__(self):
		...
		self.import_prep_apply_button = self.builder.get_object("button13")
		...
		self.import_prep_file_count = self.builder.get_object("label31")
		self.import_prep_status = self.builder.get_object("label38")
		self.path_label = self.builder.get_object("entry3")
	...
	def filechooserdialog_open_button_clicked(self, widget, data=None):
		...
		self.path_label.set_text(str(self.selection))
		self.import_prep_status.set_text(str("loading..."))
		total_file_count = dir_parser.import_prep(self.selection)
		self.import_prep_file_count.set_text(str(total_file_count))
